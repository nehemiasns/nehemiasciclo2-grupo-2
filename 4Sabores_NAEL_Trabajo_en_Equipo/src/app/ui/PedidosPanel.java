...
public class PedidosPanel extends JPanel {
    ...
    // menú por categorías y mapa plano para buscar precio rápido
    ...
    private void inicializarMenuPorCategorias() {
        ...
        combos.put("Combo Sándwich", 19.00);
        ...
        bebidas.put("Jugo de Piña", 5.50);
        bebidas.put("Cerveza", 10.00);
        bebidas.put("Limonada", 6.00);
        bebidas.put("Té Helado", 4.00);
        ...
        acompanamientos.put("Ensalada César", 9.00);
        ...
        menuPorCategorias.put("Acompañamientos", acompanamientos);

        // imágenes (completa con tus rutas)
        ...
        images.put("Combo Pollo BBQ", "img/combo_pollo_bbq.png");
        images.put("Combo Doble", "img/combo_doble.png");
        images.put("Combo Familiar Especial", "img/combo_familiar.png");
        images.put("Combo Twister", "img/combo_twister.png");
        images.put("Combo Papa + Pollo", "img/combo_papapollo.png");
        images.put("Combo Hamburguesa + Papas", "img/combo_hamburguesapapas.png");
        images.put("Combo Sándwich", "img/combo_sandwich.png");

        images.put("Twister BBQ", "img/twister.png");
        images.put("Hamburguesa Crispy", "img/hamburguesa-bacon-burger-214281.png");
        images.put("Hamburguesa BBQ", "img/hamburguesabbqbacon.png");
        images.put("Hamburguesa Pollo", "img/hamburguesapollo.png");
        images.put("Hamburguesa Doble", "img/hamburguesa_doble.png");
        images.put("Hamburguesa Bacon", "img/hamburguesa_bacon.png");
        images.put("Hamburguesa Queso", "img/hamburguesaqueso.png");
        images.put("Hamburguesa Veggie", "img/hamburguesaveggie.png");
        images.put("Hamburguesa BBQ Bacon", "img/hamburguesabacon.png");
        images.put("Hamburguesa Deluxe", "img/hamburguesa_deluxe.png");

        images.put("Inka Kola 500 ml", "img/inkacola.png");
        images.put("Chicha Morada 1L", "img/chicha.png");
        images.put("Agua Mineral 500 ml", "img/agua.png");
        images.put("Gaseosa Coca-Cola 500 ml", "img/cocacola.png");
        images.put("Gaseosa Coca-Cola 1L", "img/cocacola1l.png");
        images.put("Jugo de Naranja", "img/jugo_naranja.png");
        images.put("Jugo de Piña", "img/jugo_pina.png");
        images.put("Cerveza", "img/cerveza.png");
        images.put("Limonada", "img/limonada.png");
        images.put("Té Helado", "img/tehelado.png");

        images.put("Pie de Manzana", "img/pie.png");
        images.put("Brownie", "img/brownie.png");
        images.put("Helado Vainilla", "img/helado.png");
        images.put("Pastel de Queso", "img/pastel.png");
        images.put("Galletas", "img/galletas.png");
        images.put("Flan", "img/flan.png");
        images.put("Tarta de Limón", "img/tarta_limon.png");
        images.put("Mousse de Chocolate", "img/mousse.png");
        images.put("Pudding de Caramelo", "img/pudding.png");
        images.put("Tiramisú", "img/tiramisu.png");

        images.put("Papas Medianas", "img/papas.png");
        images.put("Papas Grandes", "img/papas_grandes.png");
        images.put("Ensalada César", "img/ensalada.png");
        images.put("Aros de Cebolla", "img/aros.png");
        images.put("Choclo Asado", "img/choclo.png");
        images.put("Arroz Blanco", "img/arroz.png");
        images.put("Frijoles", "img/frijoles.png");
        images.put("Panecillos", "img/panecillos.png");
        images.put("Salsa BBQ Extra", "img/salsa_bbq.png");

        // ----- construir mapa plano (nombre -> precio) para usar en carrito/totales -----
        menuFlat.clear();
        for (Map.Entry<String, Map<String, Double>> catEntry : menuPorCategorias.entrySet()) {
            Map<String, Double> prodMap = catEntry.getValue();
            for (Map.Entry<String, Double> prodEntry : prodMap.entrySet()) {
                menuFlat.put(prodEntry.getKey(), prodEntry.getValue());
            }
        }
    }
    ...
    private JPanel crearVistaBienvenida() {
        ...
        JLabel titulo = new JLabel("¡Bienvenido a 4Sabores_NAEL!", SwingConstants.CENTER);
        titulo.setFont(new Font("Arial Black", Font.BOLD, 36));
        titulo.setForeground(Color.WHITE);
        titulo.setBorder(new EmptyBorder(40, 10, 10, 10));

        JLabel subtitulo = new JLabel("Haz tu pedido o pide delivery 😋🍔", SwingConstants.CENTER);
    ...
    private JPanel crearVistaPedidos() {
        ...
        // GRID catálogo (mostramos categorías + productos)
        ...
        for (var categoria : menuPorCategorias.entrySet()) {
            // título categoría (ocupa una celda)
    ...
    private String generarMensajeWhatsapp() {
        if (carrito.isEmpty()) return "Hola! Aún no he seleccionado ningún producto.";
        StringBuilder sb = new StringBuilder("Hola! Quiero hacer un pedido desde la app 4Sabores_NAEL:\n\n");
        double subtotal = 0.0;
    ...
    private void actualizarCarritoVista() {
        ...
        for (var entry : carrito.entrySet()) {
            ...
            cartModel.addElement(String.format("%s x%d — S/ %.2f", nombre, cantidad, itemTotal));
            subtotal += itemTotal;
        }
        double igv = subtotal * IGV;
        double total = subtotal + igv;
    ...
    private void onCheckout(ActionEvent e) {
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            ...
            } catch (Exception ex) { /* ignoramos aquí */ }
